...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (gwbrck/leader-keys
      ...
      "bs" '(bufler-switch-buffer :which-key "list buffer")
...
#+begin_src emacs-lisp
    ...
    (use-package org
     ...
     (setq org-agenda-files (list gwbrck/roam))
  ...
  (setq ispell-program-name "hunspell"          ; Use hunspell to correct mistakes
    ...
    (setq langtool-language-tool-server-jar
          (substring (shell-command-to-string
                                          "echo /usr/local/Cellar/languagetool/*/libexec/languagetool-server.jar") 0 -1))
