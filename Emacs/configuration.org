#+TITLE: Config based on Emacs From Scratch
#+STARTUP hideblocks
...
#+begin_src emacs-lisp
  ...
  (use-package general
   ...
   (gwbrck/leader-keys
     ...
     "fb"  '((lambda () (interactive) (counsel-find-file "~/Documents/MacsBib")) :which-key "Bib")
...
** Default Bibpath
#+begin_src emacs-lisp
(setq myBib '("~/Documents/MacsBib/main.bib"))
(setq myPdfs  "~/Documents/MacsBib/pdfs")
(setq myRoam "~/Documents/MacsBib/Roam")
#+end_src
** Standi Configs
#+begin_src emacs-lisp
(use-package ivy-bibtex
     :config
     (setq bibtex-completion-bibliography myBib)
...
(use-package org-ref
  :config
  (setq org-ref-default-bibliography myBib)
  (setq org-ref-pdf-directory myPdfs)
...
#+begin_src emacs-lisp
  ...
  (defun gwbrck/bibtex-clean-entry ()
    (interactive)
    (save-excursion
      (save-restriction
